...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f1e9;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f1e9; padding: 40px 20px;">
    ...
    `,
    textContent: 'Seu pedido foi agendado! Preparamos tudo fresquinho no horário escolhido.',
    buttonText: 'Ver Meu Pedido',
    buttonUrl: 'https://sushiworld.pt/pedidos/{{orderId}}',
    buttonColor: '#FF6B00',
  },

  {
    ...
    subject: '❌ Pedido Agendado Cancelado #{{orderNumber}}',
    htmlContent: `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f1e9;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f1e9; padding: 40px 20px;">
    ...
    `,
    textContent: 'Seu pedido agendado foi cancelado. Entre em contato para mais informações.',
