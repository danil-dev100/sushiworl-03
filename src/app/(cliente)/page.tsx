...
export const metadata = {
  title: 'SushiWorld - O Melhor Sushi da Cidade',
  description: 'SushiWorld: O Sabor do Japão na Sua Casa. Desfrute dos melhores sushis frescos e deliciosos entregues diretamente na sua porta.',
};
...
const destaques = [
  ...
  },
  {
    ...
    price: '€13.00',
    category: 'Makis',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBQrGLmRYLCS48mw9osKHQY8cRJqX_Viua_yO1j3lpFFbN87CXS-4B_3k0echZiFjRVEqvgOtovXl438-AIBgFEOJCmKGy_zYpQp8WQRzHoFEZglG5ZQM-z-FUxdJ45d8C1D_q821k46DJ1UR7jqbPBXGySW4zmn8tMrMX_mwuJbaPHIhtgzPezAEqDR5MNq6xs-a6pX7_qX-LQSQr5DnbsZYu7J0XqEdVp_8_cH6hKvb5gh7Krj-M4umtQygY6CdP1L2qZfXiKdOQ',
  },
  {
    id: 6,
    name: 'Spicy Tuna',
...
export default function HomePage() {
  const categories = ['Mais Vendidos', 'Destaques'];
